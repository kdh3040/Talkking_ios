...
struct CommonData {
    ...
    public static let FAN_RANK_ICON_BIG = ["icon_fan_rank_big_1", "icon_fan_rank_big_2", "icon_fan_rank_big_3"]
    public static let FAN_RANK_ICON = ["icon_fan_rank_1", "icon_fan_rank_2", "icon_fan_rank_3"]
